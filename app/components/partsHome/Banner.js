        ...
        <div className="bg-white">
            ...
            <div className="bg-white lg:py-20 py-10 ">
                <div className="lg:grid grid-cols-2 gap-3 ">
                    <div className=" w-[90%] mx-auto">
                        ...
                        <h1 className="font-bold text-[#051145] text-center   lg:text-[70px] lg:leading-[70px] text-[28px] leading-[28px] ">
            ...
            <div className=" promobg   py-10">
                ...
                <div className="lg:grid  lg:grid-cols-3 flex flex-col  items-center lg:gap-20 lg:p-20 p-5">
                    <div className="col-span-2">
                        <h1 className="text-[#051145] lg:text-[72px] text-[28px] font-[700] leading-[28px] lg:leading-[72px] text-left ">Discount up to <br />35% for first <br /> member!</h1>
